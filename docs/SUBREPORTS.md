...
supported for `PDF`, `DOCX_EDITABLE`, `DOCX_VISUAL`, and the default XLSX `REPORT` layout. XLSX `DATA`
fails closed because it cannot preserve a child grid inside the invoking parent cell.
